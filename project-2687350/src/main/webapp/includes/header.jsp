                    ...
                    <div class="d-flex  align-items-center justify-content-between">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="products_register">PRODUCTOS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="category_register">CATEGORIA</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="user_register">INICIAR SESION</a>
                                </li>
                            </ul>
                        </div>
